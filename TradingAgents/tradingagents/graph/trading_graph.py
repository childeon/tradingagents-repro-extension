...
# Changes: Added ablation_mode validation and registered get_social_sentiment tool for social-media agents.
...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        valid_ablation_modes = {"full", "no_research_debate", "no_risk_layer"}
    ...
    def _create_tool_nodes(self) -> Dict[str, ToolNode]:
        ...
        return {
            ...
            "social": ToolNode(
                [
                    # Local social media sentiment analysis
                    get_social_sentiment,
                ]
            ),
            "news": ToolNode(
