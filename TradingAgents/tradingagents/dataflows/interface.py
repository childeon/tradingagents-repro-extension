...
# Changes: Registered 'sec' and 'local' data-vendor backends for SEC fundamentals and local GDELT/Reddit news.
...
from .local_news import get_news_local, get_global_news_local
...
VENDOR_METHODS = {
    ...
    # news_data
    "get_news": {
        "local": get_news_local,
        "alpha_vantage": get_alpha_vantage_news,
        "yfinance": get_news_yfinance,
    },
    "get_global_news": {
        "local": get_global_news_local,
