...
# Changes: Added ablation_mode key ('full' | 'no_research_debate' | 'no_risk_layer') for ablation experiments.
import os
...
DEFAULT_CONFIG = {
    ...
    # Experiment mode:
    # - "full": original graph
    # - "no_research_debate": analysts -> research manager -> trader, risk layer intact
    # - "no_risk_layer": research debate intact, trader -> portfolio manager
    "ablation_mode": "full",
